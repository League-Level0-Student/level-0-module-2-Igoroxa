...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		// 2) Ask the user to enter their height in inches using JOptionPane and set it to the variable heightToRide
			String heightToRide = JOptionPane.showInputDialog("Put your height in INCHES");
		...
		if (heightAsInt >= 48) {
			JOptionPane.showMessageDialog(null, "Hooray, You can ride the ride");
		}
		// 5) Else if the heightAsInt is greater than or equal to 42 inches tall print:
		// "You can ride the coaster with someone else!" 
		else {
			JOptionPane.showMessageDialog(null, "Get Taller and come next time");
		}
