...
String fourAsString = JOptionPane.showInputDialog("enter in 4");
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
 String sixAsString = JOptionPane.showInputDialog("enter in 6");
			...
			String fiveAsString = JOptionPane.showInputDialog("enter in 5");
